...
void main() async {
  ...
  print('📁 Saved to: assets/images/app_icon.png');
  print('🎨 Icon features:');
  print('   - Green gradient background');
  print('   - Clean white leaf/plant icon');
  print('   - Subtle glow effect');
  print('   - Professional design');
  print('');
  print('🚀 Now you can build the APK with:');
