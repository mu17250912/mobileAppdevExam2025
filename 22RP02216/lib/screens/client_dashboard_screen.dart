...
import 'talent_list_screen.dart';
...
class ClientDashboardScreen extends StatefulWidget {
  final String name;
  const ClientDashboardScreen({Key? key, required this.name}) : super(key: key);
...
class _ClientDashboardScreenState extends State<ClientDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    final List<Widget> _tabs = [
      ...
      Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Icon(Icons.event_rounded, size: 64, color: Colors.deepPurple),
              ...
              ElevatedButton.icon(
                ...
                label: const Text('Browse Talents'),
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => const TalentListScreen(),
                    ),
                  );
                },
      ...
      // Bookings Tab
      BookingHistoryScreen(forTalent: false),
      // Profile Tab
      ClientProfileScreen(), // To be implemented
    ];
