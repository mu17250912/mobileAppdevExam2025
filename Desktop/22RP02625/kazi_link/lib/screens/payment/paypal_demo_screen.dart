...
class PayPalDemoScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    const String paypalClientId = 'YOUR_PAYPAL_CLIENT_ID'; // Placeholder
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [
                      ...
                      const Color(0xFF1546A0).withOpacity(0.05),
                    ],
                  ),
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      'Test PayPal integration with demo credentials',
                      style: GoogleFonts.poppins(
                    ...
                    SnackBar(
                      content: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'Simulated PayPal payment successful! (Demo only)',
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 8),
                    Text(
                      'Integrate your backend logic and PayPal SDK here for production use.',
                      style: GoogleFonts.poppins(
                        fontWeight: FontWeight.w400,
                        fontSize: 14,
                        color: colorScheme.onSurfaceVariant,
