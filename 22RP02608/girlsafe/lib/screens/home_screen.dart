      ...
      body: ListView(
        ...
        children: [
          ...
          Card(
            ...
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Freemium vs Premium', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Freemium', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.green[700])),
                            const SizedBox(height: 8),
                            const Text('• Soma articles y’ibanze'),
                            const Text('• Chat y’ibanze'),
                            const Text('• Kwibutsa'),
                          ],
                        ),
                      ),
                      ...
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Premium', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.amber[800])),
                            const SizedBox(height: 8),
          ...
          Padding(
            ...
            child: Text('Main Features', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.bold)),
          ),
          // Main Navigation
